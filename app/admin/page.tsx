...
import { IProduct, ICategory, validateProduct } from "@/types";
      ...
      <div className="bg-white rounded-lg shadow-xl p-6 sm:p-8 w-full max-w-2xl relative max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-3 p-4 border border-gray-200 rounded-md">
              ...
              ([key, value]) => (
                ...
                >
                  <input
                    ...
                    value={key}
                    disabled
                    className="flex-1 px-2 py-1 border border-gray-200 rounded bg-gray-100 text-sm text-gray-500"
                  />
            ...
            <div className="flex items-end space-x-2 pt-2">
              ...
              <button
                ...
                className="px-3 py-1.5 bg-blue-500 text-white rounded-md hover:bg-blue-600 text-sm font-medium flex items-center space-x-1"
              >
          ...
          <div className="flex justify-end space-x-3 pt-5 border-t border-gray-200">
            ...
            <button
              type="submit"
              className="bg-primary-500 text-white px-6 py-2 rounded-lg hover:bg-primary-600 font-semibold transition-colors flex items-center space-x-2"
            >
    ...
    {loadingCategories ? (
      ...
      <div className="space-y-3">
        {categories.map((cat) => (
          <div
            key={cat._id}
            className="p-4 bg-gray-50 rounded-lg shadow-sm flex justify-between items-start border border-gray-200"
          >
            ...
            <div className="flex-shrink-0 flex flex-col sm:flex-row items-end sm:items-center space-y-1 sm:space-y-0 sm:space-x-2">
              <button
                onClick={() => onEdit(cat)}
                className="p-2 text-blue-500 hover:text-blue-700 hover:bg-blue-50 rounded-md text-xs flex items-center"
              >
                <Edit className="w-3.5 h-3.5 mr-1" /> Ред.
              </button>
              <button
                onClick={() => onDelete(cat._id)}
                className="p-2 text-red-500 hover:text-red-700 hover:bg-red-50 rounded-md text-xs flex items-center"
              >
                <Trash2 className="w-3.5 h-3.5 mr-1" /> Удал.
              </button>
            </div>
          </div>
        ))}
        ...
        <div className="bg-white p-6 sm:p-8 rounded-lg shadow-xl w-full max-w-lg relative max-h-[90vh] overflow-y-auto">
          ...
          >
            ...
            <div>
              ...
              >
                {" "}
                <Plus className="w-4 h-4" /> <span>Добавить подкатегорию</span>{" "}
              </button>
            </div>
            ...
            <div className="flex justify-end space-x-3 pt-5 border-t border-gray-200">
              ...
              >
                {" "}
                <Save className="w-4 h-4" /> <span>Сохранить категорию</span>{" "}
              </button>
            </div>
          </form>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-2xl overflow-hidden">
          ...
          <div className="border-b border-gray-200 bg-gray-50">
            ...
            >
              ...
              >
                <Package className="inline-block w-5 h-5 mr-2 align-text-bottom" />{" "}
              ...
              <button
                ...
                className={`whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm transition-colors
                  ...
                  focus:outline-none focus:ring-2 focus:ring-primary-400 focus:ring-offset-1 rounded-t-md mx-1`}
              >
                <ListChecks className="inline-block w-5 h-5 mr-2 align-text-bottom" />{" "}
                          ...
                          >
                            ...
                            <td className="px-6 py-3 whitespace-nowrap text-sm font-medium space-x-2">
                              <Link
                                ...
                                className="p-1.5 text-blue-600 hover:text-blue-800 hover:bg-blue-50 rounded-md inline-flex items-center"
                              >
                              ...
                              <button
                                ...
                                className="p-1.5 text-yellow-600 hover:text-yellow-800 hover:bg-yellow-50 rounded-md inline-flex items-center"
                              >
                              ...
                              <button
                                ...
                                title="Удалить товар"
                                className="p-1.5 text-red-600 hover:text-red-800 hover:bg-red-50 rounded-md inline-flex items-center"
                              >
                                <Trash2 className="w-4 h-4" />
                              </button>
                            </td>
