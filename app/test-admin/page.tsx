  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      try {
        ...
        addLog(
          `Products response headers: ${JSON.stringify(Object.fromEntries(productsResponse.headers.entries()))}`
        );
        ...
        if (productsResponse.ok) {
          ...
          addLog(
            `Products fetch failed: ${productsResponse.status} - ${errorText}`
          );
        ...
        if (categoriesResponse.ok) {
          ...
          addLog(
            `Categories fetch failed: ${categoriesResponse.status} - ${errorText}`
          );
