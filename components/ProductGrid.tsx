        ...
        {products.map(product => (
          <motion.div key={product._id} variants={itemVariants}>
            <Link
              ...
              className="block flex overflow-hidden rounded-lg bg-white shadow-lg transition-shadow duration-300 hover:shadow-xl"
            >
    ...
    >
      {products.map(product => (
        <motion.div key={product._id} variants={itemVariants}>
          <Link
            href={`/${locale}/products/${product._id}`}
            className="group relative block overflow-hidden rounded-lg bg-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
          >
