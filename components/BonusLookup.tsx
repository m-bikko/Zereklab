  ...
  return (
    <div className="mx-auto max-w-md rounded-lg bg-white p-6 shadow-lg">
      <div className="mb-6 text-center">
        ...
        <p className="text-gray-600">Введите номер телефона или ФИО для проверки накопленных бонусов</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        {searchType === 'phone' ? (
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-gray-300 py-3 px-4 focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500"
            />
          </div>
        )}
        ...
        <button
          type="submit"
          disabled={loading || (searchType === 'phone' && !isValidPhoneNumber(phoneNumber)) || (searchType === 'name' && !fullName.trim())}
